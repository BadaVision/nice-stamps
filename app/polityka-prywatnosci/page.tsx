      ...
      <div className="max-w-4xl mx-auto px-6 pt-40 pb-32 md:pt-48 md:pb-40">
        ...
        <section>
          ...
          <p className="text-gray-400 leading-relaxed mb-6">
            {formatPolishText(
              "Administratorem Twoich danych osobowych jest firma Mikołaj Wojtkowiak MICKS, z siedzibą przy os. Armii Krajowej 102, 61-381 Poznań, NIP: 7822433639. W sprawach związanych z przetwarzaniem i ochroną danych osobowych możesz kontaktować się z nami pod adresem e-mail: hello@nice-stamps.com lub telefonicznie: +48 511 828 797."
            )}
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-400 leading-relaxed mb-6">
            ...
            <a href="mailto:hello@nice-stamps.com" className="text-white hover:text-gray-300 transition-colors">hello@nice-stamps.com</a>
            {formatPolishText(
