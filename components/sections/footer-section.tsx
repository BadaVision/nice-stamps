        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-3 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-zinc-400">
              ...
              <p>os. Armii Krajowej 102</p>
              <p>61-381 Poznań</p>
              <p>NIP: 7822433639</p>
              <p className="pt-2">E-mail: <a href="mailto:hello@nice-stamps.com" className="hover:text-[#C5A059] transition-colors">hello@nice-stamps.com</a></p>
              <p>Tel: <a href="tel:+48511828797" className="hover:text-[#C5A059] transition-colors">+48 511 828 797</a></p>
            </div>
          </div>
        </div>
      </div>
