    ...
    <section id="products" className="bg-black">
              ...
              <div className="max-lg:overflow-hidden rounded-2xl">
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute bottom-6 left-6">
                      <span className="backdrop-blur-md px-4 py-2 text-sm font-medium rounded-full bg-[rgba(255,255,255,0.2)] text-white">
                        Płyty barmańskie z mnogimi wzorami
                      </span>
                    </div>
                  </div>
                </motion.div>
      ...
      <div className="px-6 py-20 md:px-12 md:py-28 lg:px-20 lg:py-36 lg:pb-14">
        <div className="text-center">
          <p className="text-sm md:text-base uppercase tracking-widest text-zinc-400">
            Rzemiosło i precyzja
          </p>
          <p className="mt-8 leading-relaxed text-zinc-400 text-3xl text-center">
            {formatPolishText(
              "Nice Stamps to fuzja blisko 20-letniego doświadczenia w precyzyjnej obróbce na maszynach CNC oraz pasji do branży premium hospitality. W naszej pracowni tworzymy personalizowane produkty premium, takie jak: stemple do lodu, płyty barmańskie z geometrycznymi wzorami i wysokiej jakości podkładki stołowe. Zamieniają one serwowanie drinków w niezapomniany rytuał, którego doświadczą Wasi goście. Wszystkie używane przez nas materiały pochodzą ze sprawdzonych i pewnych źródeł wyselekcjonowanych z najwyższą dbałością o ich jakość."
            )}
          </p>
        </div>
      </div>
