    ...
    <section id="about" className="bg-black">
      ...
      <div className="px-6 py-24 md:px-12 md:py-32 lg:px-20 lg:py-40">
        <ScrollRevealText 
          ...
          text="Za Nice Stamps stoją niemal dwie dekady doświadczeń w precyzyjnej obróbce grawerowania i frezowania. Nie uznajemy kompromisów. Od personalizowanych stempli z logo, przez mosiężne tace, aż po tłoczone na gorąco podkładki – każda realizacja opuszcza nasz park maszynowy dopiero, gdy spełnia rygorystyczne normy perfekcji. Jesteśmy tu po to, aby Twoja marka zostawiła po sobie trwały ślad. Dosłownie." 
        />
      </div>
