  ...
  return (
    <section id="about" className="bg-black">
      ...
      <div className="px-6 py-24 md:px-12 md:py-32 lg:px-20 lg:py-40">
        <p className="mx-auto max-w-5xl text-2xl leading-relaxed text-zinc-300 md:text-3xl lg:text-[2.5rem] lg:leading-snug">
          Za Nice Stamps stoją niemal dwie dekady doświadczeń w zaawansowanym grawerowaniu i frezowaniu matryc poligraficznych. Nie uznajemy kompromisów. Od personalizowanych stempli z logo, przez mosiężne tace, aż po tłoczone na gorąco podkładki – każda realizacja opuszcza nasz park maszynowy dopiero, gdy spełnia rygorystyczne normy perfekcji. Jesteśmy tu po to, aby Twoja marka zostawiła po sobie trwały ślad. Dosłownie.
        </p>
      </div>
