...
const sideImages = [
  {
    src: "/images/kostka-lodu-z-logo-lewy-gora.webp",
    alt: "Przejrzysta kostka lodu z wytłoczonym logo za pomocą stempla",
    position: "left",
    span: 1,
  },
  {
    src: "/images/wzor-na-lodzie-plyta-lewy-dol.webp",
    alt: "Geometryczny wzór na lodzie stworzony matrycą barmańską",
    position: "left",
    span: 1,
  },
  {
    src: "/images/lud-z-brandingiem-prawy-gora.webp",
    alt: "Lód z brandingiem lokalu serwowany w luksusowym drinku",
    position: "right",
    span: 1,
  },
  {
    src: "/images/personalizowany-lod-prawy-dol.webp",
    alt: "Personalizowany lód barmański w szklance typu rocks",
    position: "right",
    span: 1,
  },
];
...
export function TechnologySection() {
  ...
  return (
    <section id="filozofia" ref={sectionRef} className="relative bg-black">
      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        <div className="flex h-full w-full items-center justify-center">
          ...
          >
            ...
            >
              <Image
                src="/images/personalizowana-kostka-lodu-z-logo-center.webp"
                alt="Personalizowana kostka lodu z wytłoczonym logo Alchemy i mosiężny stempel barmański"
                fill
                className="object-cover w-full h-full"
              />
              ...
              >
                <h2 className="max-w-3xl font-medium leading-tight tracking-tight text-white md:text-5xl lg:text-7xl text-5xl">
                  {["Detal,", "który zatrzymuje", "spojrzenia."].map((word, index) => {
